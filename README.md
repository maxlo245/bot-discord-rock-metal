...
- Un embed **« L'essentiel Metal & Rock »** est envoyé chaque jour à `19:00` (heure de Paris par défaut) avec les dix informations les plus importantes de la journée, classées par urgence, importance et date, avec l'URL de chaque article.
